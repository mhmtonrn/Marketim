...
public class MarketHelper {
    ...
    public List<MarketModel> getMarkerLocation(){
        ...
        markerList.add(new MarketModel("1","Mehmet Market","konya",5,new LatLng(40.72939739873268,29.2016827539186)));
        ...
        markerList.add(new MarketModel("1","Van Bakkal","karaman",5,new LatLng(40.929202720341294,29.301394854743183)));
